...
import Audiogram from './pictures/Audiogram.png';
import './App.css';
  ...
  return (
    <div>
      ...
      <section className="Test">
        ...
        <h3>In the graph below it goes through how each modification of the video represents the hearing loss you might experience. Each press of the frequency buttons change the pitch by 250 whereas each press of the decibel button change the loudness by 10.</h3>
        <img src={Audiogram}></img>
      </section>
    </div>
  );
}
